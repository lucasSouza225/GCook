...
public class HomeController : Controller
{
    ...
    {
        Receita receita = _context.Receitas .Where(r => r.Id == id).Include(r => r.Categoria).Include(r => r.Ingredientes).ThenInclude(i => i.Ingrediente).AsNoTracking().FirstOrDefault();
        return View(receita);
    }
